    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-content">
                    <p class="category"><strong>Total Alumni</strong></p>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="card card-stats">
                <div class="card-header">
                    ...
                    <i class="fa-solid fa-3x fa-file"></i>

                    </div>
                </div>
                <div class="card-content">
                    <p class="category"><strong>Total Program</strong></p>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-content">
                    <p class="category"><strong>Total Pending</strong></p>
        ...
        <div class="col-lg-7 col-md-12">
            <div class="card" style="min-height: 485px">
                <div class="card-header card-header-text">
                    <h4 class="card-title">Display Data</h4>
                    <p class="category"></p>
                </div>
