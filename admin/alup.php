                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-12 p-2">
                                                        ...
                                                        <input type="text" class="form-control" name="civil"
                                                            value="<?=$row['civilstatus']?>" required>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-12 p-2">
                                                        ...
                                                        <input type="text" class="form-control" name="batchyear"
                                                            value="<?=$row['batchyear']?>" required>
                                                    </div>

                                                    <div class="col-md-6 col-sm-12 p-2">
                                                        <label>Student Number</label>
                                                        <input type="text" class="form-control" name="studentnumber"
                                                            value="<?=$row['studentnumber']?>" required>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-12 p-2">
                                                        ...
                                                        <input type="text" class="form-control" name="emplostat"
                                                            value="<?=$row['emplosta']?>">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-12 p-2">
                                                        ...
                                                        <input type="text" class="form-control" name="workpos"
                                                            value="<?=$row['workpos']?>">
                                                    </div>

                                                    <div class="col-md-6 col-sm-12 p-2">
                                                        <label>Year of Service</label>
                                                        <input type="text" class="form-control" name="yearservice"
                                                            value="<?=$row['yearservice']?>">
                                                    </div>
...
$alert = '';
                            ...
                            if(isset($_POST['save']) && !empty($_POST['id'])){
                             ...
                             mysqli_query($connection, "update alumnistudents set fname ='$firstname', mname='$middlename',lname='$lastname',exname='$extension',civilstatus='$civil',gender='$gender',datebirth='$datebirth',placebirth='$placebirth',citizen='$citizen',email='$email',mobile='$mobilenum',city='$city',province='$province',batchyear='$batchyear', studentnumber='$studentnumber',course='$program',major='$major',emplosta='$emplostat',companyname='$companyname',workpos='$workpos',yearservice='$yearservice',industry='$industry',others='$others', status = 1 where alumni_id='$get_id'") or die($connection->error);
                                  
                              
        
                            echo ('<script>location.href = "alumni"</script>');
