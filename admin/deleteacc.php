        ...
        <div class="top-navbar">
            <nav class="navbar navbar-expand-lg">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand" href="#"> Deleted Account </a>
                                ...
                                <div class="col-12">
                                    <div class="table-responsive pb-5">
                                        <table
                                            ...
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($conn, "select * FROM alumnistudents where status=3") or die($conn->error);
                                                ...
                                                <?php include('delete_archivemodal.php');?>
                                                <?php } ?>
                                            </tbody>
                                        </table>
                                    </div>
